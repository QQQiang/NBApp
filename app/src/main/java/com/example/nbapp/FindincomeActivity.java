...
public class FindincomeActivity extends AppCompatActivity {

    private String TAG="FindIncomeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.findincome);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(FindincomeActivity.this,FindActivity.class);
    ...
    private void setMPieView(){
        ...
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(FindincomeActivity.this);
    ...
    private void setMTypeList(){
        ...
        double temp=0;
        monthexpend=0;
        mMExpendList= DataSupport.where("month=? and sign=?", getSysMonth(),1+"").find(Record.class);
    ...
    private void setYTypeList(){
        int i=0;
        mYExpendList=DataSupport.where("year=? and sign=?",getSysYear(),1+"").find(Record.class);
