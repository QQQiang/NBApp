...
public class PieView_inco extends View {
    ...
    public PieView_inco(Context context) {
        this(context, null);
    }

    public PieView_inco(Context context, AttributeSet attrs) {
        super(context, attrs);
